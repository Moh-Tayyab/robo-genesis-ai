---
id: 0005
title: Commit and Push Project Configuration
stage: general
date: 2025-12-04
surface: agent
...
user: user
command: /sp.git.commit_pr -441e160 please check this branch
labels: ["git", "commit", "push", "configuration"]
links:
  spec: null
  ticket: null
  adr: null
...
files:
  ...
  - CLAUDE.md
  - frontend/scripts/validate-metadata.js
  - frontend/sidebars.js
  - frontend/src/components/RobotCursor.tsx
  - frontend/src/components/RoboticsCard.module.css
  - frontend/src/components/RoboticsCard.tsx
  - frontend/src/css/custom.css
  - frontend/static/lottie/humanoid_walk.json
tests:
  - null
---
...
[Request interrupted by user for tool use]<command-message>sp.git.commit_pr is running…</command-message>
<command-name>/sp.git.commit_pr</command-name>
<command-args>    -441e160 please check this branch</command-args>Your task is to intelligently executes git workflows to commit the work and create PR following your Principles
